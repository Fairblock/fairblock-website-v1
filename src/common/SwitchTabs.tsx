...
const SwitchTabs = ({
  ...
  return (
    <div className="flex flex-col gap-12">
      <div className="flex flex-nowrap rounded-lg mx-auto text-lg sm:text-2xl w-[90%] sm:w-[550px]">
        <button
          className={`${
            activeTab === firstTabLabel ? "bg-primary-blue" : "bg-primary-blue/10"
          } border border-primary-blue cursor-pointer p-2 rounded-l-md sm:rounded-l-xl text-nowrap min-w-1/2`}
        ...
        <button
          ...
          } border border-primary-blue cursor-pointer p-2 rounded-r-md sm:rounded-r-xl text-nowrap min-w-1/2`}
