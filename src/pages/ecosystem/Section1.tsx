...
const Section1 = () => {
  return (
    <div className="bg-[url(/ecosystem/hero-mobile.svg)] md:bg-[url(/ecosystem/hero-desktop.svg)] bg-cover flex lg:items-center min-h-[60vh] sm:min-h-[50vh] xl:h-[82vh] mt-[18vh]">
      <div className="mx-auto w-[1920px]">
        <div className="flex flex-col items-start gap-6 mt-[40%] sm:mt-[25%] md:mt-[20%] mb-16 xl:mt-20 xl:mb-0 px-4 sm:px-8">
          <h1 className="font-medium font-heading text-[#141210] text-6xl lg:text-8xl">
            Ecosystem
          </h1>
