...
const StartBuildingCard = ({ imageUrl, title, content, link }: CardProps) => {
  return (
    <a href={link} target="_blank" rel="noopener noreferrer" className="bg-gradient-to-b from-primary-blue via-primary-blue/50 to-primary-blue/20 w-full md:w-80 max-w-80">
      <div className="bg-primary-darkBlue hover:cursor-pointer duration-300 flex flex-col gap-4 items-center p-4 pt-8 m-[1px] relative hover:shadow shadow-primary-blue text-white">
      <PiArrowUpRightBold className="absolute top-3 right-3 bg-primary-blue p-1 text-primary-darkBlue text-2xl" />
      <div className="w-56">
